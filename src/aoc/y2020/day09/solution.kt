...
private fun main() {
    puzzle { part1(inputLines("test.txt").asLongs(), 5) }
    puzzle { part1(inputLines("input.txt").asLongs(), 25) }
    puzzle { part2(inputLines("test.txt").asLongs(), 5) }
    puzzle { part2(inputLines("input.txt").asLongs(), 25) }
}
